...
@Test func testExampleAdding() throws {
  ...
  @Test func testTextNode() throws {
    ...
    let ln = TextNode(yogaNode: YGNode(), layoutManager: lm)
    root.add(ln.yogaNode)
    ...
    #expect(ln.yogaNode.layoutLeft == 32)
    #expect(ln.yogaNode.layoutRight == 0)
    #expect(ln.yogaNode.layoutTop == 0)
    #expect(ln.yogaNode.layoutBottom == 0)
    #expect(ln.yogaNode.layoutWidth == 68)
    #expect(ln.yogaNode.layoutHeight == 100)
  }
